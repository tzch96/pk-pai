...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo URL; ?>favicon-160x160.png" sizes="160x160" />
    <link rel="icon" type="image/png" href="<?php echo URL; ?>favicon-196x196.png" sizes="196x196" />
